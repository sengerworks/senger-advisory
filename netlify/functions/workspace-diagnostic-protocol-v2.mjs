...
export function createWorkspaceDiagnosticProtocolV2Handler({ authenticate = authenticateWorkspaceRequest, getProtocol = getDiagnosticProtocolV2, approveProtocol = approveWorkspaceDiagnosticProtocolV2 } = {}) {
