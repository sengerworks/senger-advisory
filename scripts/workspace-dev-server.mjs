...
import workspaceStewardCommandCenter from "../netlify/functions/workspace-steward-command-center.mjs";
...
const files = new Map([
  ...
  ["/workspace/workspace-intelligence.css", { url: new URL("../workspace/workspace-intelligence.css", import.meta.url), type: "text/css; charset=utf-8" }],
  ["/workspace/workspace-support.css", { url: new URL("../workspace/workspace-support.css", import.meta.url), type: "text/css; charset=utf-8" }],
  ["/workspace/workspace-orientation.css", { url: new URL("../workspace/workspace-orientation.css", import.meta.url), type: "text/css; charset=utf-8" }],
  ["/workspace/workspace.js", { url: new URL("../workspace/workspace.js", import.meta.url), type: "text/javascript; charset=utf-8" }],
  ["/workspace/workspace-intelligence.js", { url: new URL("../workspace/workspace-intelligence.js", import.meta.url), type: "text/javascript; charset=utf-8" }],
  ...
  ["/capacity-signal-assessment-app.js", { url: new URL("../capacity-signal-assessment-app.js", import.meta.url), type: "text/javascript; charset=utf-8" }],
  ["/capacity-signal-assessment-engine.js", { url: new URL("../capacity-signal-assessment-engine.js", import.meta.url), type: "text/javascript; charset=utf-8" }],
...
const server = createServer(async (nodeRequest, nodeResponse) => {
  ...
  if ([
    ...
    "/api/workspace/steward-command-center",
    ...
    const handler = url.pathname === "/api/operations/overview"
      ...
      : url.pathname.endsWith("/steward-command-center")
        ? workspaceStewardCommandCenter
